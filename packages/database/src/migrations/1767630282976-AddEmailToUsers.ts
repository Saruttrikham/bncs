...
export class AddEmailToUsers1767630282976 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "student_profiles" ADD CONSTRAINT "FK_cef016a0d95e26ae7c0f167ec28" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON DELETE CASCADE`);
        await queryRunner.query(`ALTER TABLE "student_profiles" ADD CONSTRAINT "FK_45542a7519585b831e1e1c9f2f9" FOREIGN KEY ("university_id") REFERENCES "universities" ("id")`);
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_a3ffb1c0c8416b9fc6f907b7433" FOREIGN KEY ("id") REFERENCES "student_profiles" ("user_id")`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "FK_a3ffb1c0c8416b9fc6f907b7433"`);
        await queryRunner.query(`ALTER TABLE "student_profiles" DROP CONSTRAINT "FK_45542a7519585b831e1e1c9f2f9"`);
        ...
        await queryRunner.query(`ALTER TABLE "standardized_transcripts" DROP CONSTRAINT "FK_7a559b319e8fbde9437f6724459"`);
        await queryRunner.query(`ALTER TABLE "standardized_transcripts" DROP CONSTRAINT "FK_f8209440ca5437f936ba380dbe6"`);
